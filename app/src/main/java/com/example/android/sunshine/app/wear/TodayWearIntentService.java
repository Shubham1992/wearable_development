 ...
 */
public class TodayWearIntentService extends IntentService implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
        ...
        Wearable.DataApi.putDataItem(mGoogleApiClient, request)
                .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                    ...
                    public void onResult(DataApi.DataItemResult dataItemResult) {
                        Log.e("Message", "Sending image was successful: " + dataItemResult.getStatus()
                                .isSuccess());
                    }
                });
